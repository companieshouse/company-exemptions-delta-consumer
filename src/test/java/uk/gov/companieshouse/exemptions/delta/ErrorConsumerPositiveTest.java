...
public class ErrorConsumerPositiveTest {
    ...
    @Test
    void testConsumeFromErrorTopic() throws InterruptedException, IOException {
        //given
        ...
        //then
        ConsumerRecords<String, byte[]> records = KafkaTestUtils.getRecords(testConsumer, 10000L, 1);
