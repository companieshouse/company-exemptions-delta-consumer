...
public class ServiceRouter {
     ...
     * <br>
     * If {@link ChsDelta#getIsDelete() isDelete} is true then the delta will be
     * routed to the {@link Service delete service}.
     * If {@link ChsDelta#getIsDelete() isDelete} is false then the delta will be
     * routed to the {@link Service upsert service}.
     *
     * @param delta A {@link ChsDelta delta} containing an
     *              {@link uk.gov.companieshouse.api.delta.PscExemptionDelta upsert
     *              exemption delta} or
     *              a {@link uk.gov.companieshouse.api.delta.PscExemptionDeleteDelta
     *              delete exemption delta}.
     */
